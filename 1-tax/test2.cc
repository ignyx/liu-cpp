...
int main() { 
    ...
    //Ask for the min and max values until the user give a correct input
    do{
   ...
   do{  
    ...
    cout << " " << endl;
    cout   << setfill(' ')<< right <<setw(12)<< "PRICE" <<setw(12)<< "TAX" <<setw(20)<<"PRICE WITH TAX" << endl;
    ...
    do{ 
        ...
        i++;
        cout << setfill(' ') <<right <<setw(12) << price << setw(12) << tax << setw(12)  << priceWithTax << endl;

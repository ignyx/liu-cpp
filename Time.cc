...
string to_string(Time const&  givenTime, format timeFormat){
    ...
    if(timeFormat == USA){
        if(is_am(givenTime)){
            timeString = fill_two_decimals((givenTime.hours)%12)+ ":" + fill_two_decimals(givenTime.minutes)+ ":" + fill_two_decimals(givenTime.seconds) + " AM";
        }
        else {
            timeString = fill_two_decimals((givenTime.hours)%12)+ ":" + fill_two_decimals(givenTime.minutes)+ ":" + fill_two_decimals(givenTime.seconds) + " PM";
        }

    }else{
        timeString = fill_two_decimals(givenTime.hours)+ ":" + fill_two_decimals(givenTime.minutes)+ ":" + fill_two_decimals(givenTime.seconds) ;
    }
